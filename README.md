...
- Review text-based observation guides that explain what to look for in each ECG rhythm pattern without overlaying labels on the live waveform.
...
- **Observation Guide / 観察ポイント**：実波形にラベルや模式図を重ねず、各リズムで注目すべきポイントをテキストで確認できます。
...
rhythm regularity, P-wave visibility, QRS width, PR interval behavior, dropped
beats, and other high-level recognition points.
