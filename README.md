...
- Review simplified waveform guide diagrams for key ECG concepts such as P wave, QRS complex, T wave, PR interval, RR interval, and selected rhythm comparisons.
...
- **Waveform Guide / 波形ガイド**：実波形に重ねるのではなく、学習用の模式図としてP波、QRS、T波、PR間隔、RR間隔などの見方を確認できます。
...
selected case. Supported cases include simplified Waveform Guide diagrams for
common concepts such as P wave, QRS complex, T wave, PR interval, RR interval,
and selected rhythm comparison patterns.
