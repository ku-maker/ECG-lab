...
- Review compact observation guides that summarize key rhythm-reading points without overlaying labels or diagrams on the live ECG waveform.
...
Learning Mode には **Observation Guide / 観察ポイント** があり、実波形にラベルや模式図を重ねず、各リズムの判読ポイントを短く確認できます。
