...
- Toggle educational waveform annotations for P waves, QRS complexes, T waves, PR interval, and RR interval in supported learning views.
...
- **Annotations / 波形ラベル**：P波、QRS、T波、PR間隔、RR間隔などを学習用の目安として表示できます。
...
educational annotations can be toggled for both compared waveforms.
